...
class DbusShellyemService:
  def __init__(self, servicename, paths, productname='Shelly EM', connection='Shelly EM HTTP JSON service'):
    ...
    productid = int(config['DEFAULT']['ProductID'],0)
    ...
    self._dbusservice.add_path('/ProductId', productid) # id needs to be assigned by Victron Support current value for testing
    ...
    self._dbusservice.add_path('/Role', config['DEFAULT']['Role'])
  ...
  def _update(self):
    try:
       ...
       self._dbusservice['/Ac/L1/Power'] = meter_data['emeters'][0]['power'] + meter_data['emeters'][1]['power']
       self._dbusservice['/Ac/L1/Energy/Forward'] = (meter_data['emeters'][0]['total'] + meter_data['emeters'][1]['total']/1000)
       self._dbusservice['/Ac/L1/Energy/Reverse'] = (meter_data['emeters'][0]['total_returned'] + meter_data['emeters'][1]['total_returned']/1000)

       current = self._dbusservice['/Ac/L1/Power'] / self._dbusservice['/Ac/L1/Voltage']
       ...
       #Pad the remaining phases with 0 values
